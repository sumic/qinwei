...
var App = function () {
    ...
    var handleIframeContent = function () {
        ...
        var height = App.getViewPort().height - $footer.outerHeight() - $header.outerHeight() -11;
        if ($tabs.is(":visible")) {
...
var addTabs = function (options) {
    ...
    if (findTabPanel(pageId) === null) {
        ...
        var $title = $('<a href="javascript:void(0);" title="双击刷新"></a>').attr(pageIdField, pageId).addClass("menu_tab");
...
var activeMenu = function(e){
	$("#nav-list-main").find("a").each(function(){
		if($(this).attr('data-index') == e){
