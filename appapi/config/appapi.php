...
/**
 * =======================================================
 * @Description : appapi config file
 * =======================================================
 * @copyright Copyright (c) 2018 勤为科技有限公司
 * @link: http://www.qinweigroup.cn
 * @author: sumic <sumic515@gmail.com>
 * @date: 2018年7月24日 下午3:07:06
 * @version: v1.0.0
 */
...
$config = [
    ...
    'components' => [
        ...
        'user' => [
            ...
            // 开启速度限制的 User Model
            //'identityClass' => 'core\models\mysqldb\adminUser\AdminUserAccessToken',
...
if (YII_ENV_PROD) {
    $config['components']['errorHandler']['class'] = 'core\components\AppserverErrorHandler';
}
